VULN_ID = 73537136
USAGE_ID = hash(
    "simpsonorg/sample_repo/blob/commit_id/src/packages/linked-accounts/components/LinkedAccountsTable/constants.tsx#L274",
)
    ...
    "findings": [
        {
            ...
            "repository": {
                "name": "simpsonorg/sample_repo",
                "url": "https://github.com/simpsonorg/sample_repo",
            },
            "line_of_code_url": "https://github.com/simpsonorg/sample_repo/blob/71bbed12f950de8335006d7f91112263d8504f1b/src/packages/components/AccountsTable/constants.tsx#L274",  # noqa E501
            ...
            "found_dependency": {
                ...
                "ecosystem": "npm",
                "transitivity": "direct",
                "lockfile_line_url": "https: //github.com/simpsonorg/sample_repo/blob/commit_id/package-lock.json#L14373",
            },
            ...
            "usage": {
                "location": {
                    ...
                    "end_line": 274,
                    "end_col": 62,
                    "url": "https: //github.com/simpsonorg/sample_repo/blob/commit_id/src/packages/linked-accounts/components/LinkedAccountsTable/constants.tsx#L274",  # noqa E501
                },
