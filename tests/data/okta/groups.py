...
GROUP_MEMBERS_SAMPLE_DATA = [
    {
        "_links": {
            "self": {"href": "https://example.okta.com/api/v1/users/user-001"},
        },
        ...
        "credentials": {
            ...
            "recovery_question": {
                "question": "How many acres is the farm you " "bought?",
            },
        },
        "id": "user-001",
    ...
    {
        "_links": {
            "self": {"href": "https://example.okta.com/api/v1/users/user-002"},
        },
        ...
        "credentials": {
            ...
            "provider": {"name": "OKTA", "type": "OKTA"},
            "recovery_question": {
                "question": "What year was your " "favorite gin " "invented?",
            },
        },
        "id": "user-002",
    ...
    {
        "_links": {
            "self": {"href": "https://example.okta.com/api/v1/users/user-003"},
        },
        ...
        "credentials": {
            "emails": [
                ...
                },
                {
                    "status": "VERIFIED",
                    "type": "SECONDARY",
                    "value": "charlie2@example.com",
                },
            ],
            "password": {},
            "provider": {"name": "OKTA", "type": "OKTA"},
            "recovery_question": {
                "question": "What is the last car " "you destroyed?",
            },
        },
        "id": "user-003",
        ...
        "profile": {
            ...
            "secondEmail": "charlie2@example.com",
        },
        "status": "ACTIVE",
...
def create_test_group():
    ...
    group.profile.windowsDomainQualifiedName = (
        "group_profile_windowsDomainQualifiedName_value"
    )
