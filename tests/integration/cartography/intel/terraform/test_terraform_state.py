...
def test_terraform_resources_loaded(mock_list, mock_file, neo4j_session):
    ...
    assert ("aws_caller_identity.current", "aws_caller_identity", "data") in result
    assert ("aws_iam_policy.sops", "aws_iam_policy", "managed") in result
    assert ("aws_s3_bucket.logs", "aws_s3_bucket", "managed") in result
...
def test_manages_edge_to_s3_bucket(mock_list, mock_file, neo4j_session):
    ...
    assert ("aws_s3_bucket.logs", "my-test-logs-bucket") in result
