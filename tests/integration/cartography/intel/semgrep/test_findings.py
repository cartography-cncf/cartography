...
def test_sync_findings(mock_get_sca_vulns, mock_get_deployment, neo4j_session):
    ...
    assert check_nodes_as_list(
        ...
        "moment|2.29.4",
        "package-lock.json",
        "https: //github.com/simpsonorg/sample_repo/blob/commit_id/package-lock.json#L14373",
        [
    ...
    assert check_nodes(
        ...
        (
            ...
            274,
            62,
            "https: //github.com/simpsonorg/sample_repo/blob/commit_id/src/packages/linked-accounts/components/LinkedAccountsTable/constants.tsx#L274",  # noqa E501
        ),
    }
