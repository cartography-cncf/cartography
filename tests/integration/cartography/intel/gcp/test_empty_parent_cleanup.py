...
def test_backup_cleanup_runs_with_empty_clusters(neo4j_session):
    ...
    # Empty clusters list - previously this would skip cleanup at the caller.
...
def test_cluster_cleanup_runs_with_empty_instances(neo4j_session):
...
def test_deployed_models_cleanup_runs_with_empty_endpoints(neo4j_session):
    ...
    remaining_models = check_nodes(neo4j_session, "GCPVertexAIDeployedModel", ["id"])
