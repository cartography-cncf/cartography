...
@patch.object(
    groups, "get_members_for_groups", return_value=MOCK_GOOGLEWORKSPACE_MEMBERS_BY_GROUP_EMAIL
)
@patch.object(groups, "get_all_groups", return_value=MOCK_GOOGLEWORKSPACE_GROUPS_RESPONSE)
@patch.object(users, "get_all_users", return_value=MOCK_GOOGLEWORKSPACE_USERS_RESPONSE)
def test_sync_googleworkspace_users_creates_user_group_memberships(
    mock_get_all_users,
    mock_get_all_groups,
