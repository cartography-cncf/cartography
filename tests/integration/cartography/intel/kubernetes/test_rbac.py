...
def test_load_rbac_nodes(neo4j_session, _create_test_cluster):
    ...
    cluster_1_sa_data = transform_service_accounts(KUBERNETES_CLUSTER_1_SERVICE_ACCOUNTS_RAW)
    ...
    cluster_2_sa_data = transform_service_accounts(KUBERNETES_CLUSTER_2_SERVICE_ACCOUNTS_RAW)
    ...
    assert check_nodes(neo4j_session, "KubernetesServiceAccount", ["id"]) == expected_service_accounts
    ...
    assert check_nodes(neo4j_session, "KubernetesRoleBinding", ["id"]) == expected_role_bindings
