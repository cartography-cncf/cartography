...
from cartography.models.aws.identitycenter.awspermissionset import RoleAssignmentAllowedByMatchLink
...
def test_querybuilder_metadata_module_name():
    ...
    assert _get_module_from_schema(RoleAssignmentAllowedByMatchLink) == "cartography:aws"


def test_querybuilder_metadata_external_module_name():
    # Test for Schema defined outside of cartography.models
    assert _get_module_from_schema(SimpleNodeSchema) == "unknown:tests.data.graph.querybuilder.sample_models.simple_node"
