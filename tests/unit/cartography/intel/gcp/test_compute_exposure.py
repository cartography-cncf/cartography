...
def test_transform_gcp_backend_services_handles_non_v1_uri_shape():
    response = {
        ...
        "items": [
            {
                "name": "bs-non-v1",
                "securityPolicy": "https://www.googleapis.com/compute/beta/projects/sample-project-123456/global/securityPolicies/policy-beta",
                "backends": [
                    {
                        "group": "projects/sample-project-123456/zones/us-central1-a/instanceGroups/ig-already-partial",
                    },
                ],
            },
        ],
    ...
    assert (
        item["security_policy_partial_uri"]
        == "https://www.googleapis.com/compute/beta/projects/sample-project-123456/global/securityPolicies/policy-beta"
    )
    assert item["backend_group_partial_uris"] == [
        "projects/sample-project-123456/zones/us-central1-a/instanceGroups/ig-already-partial",
    ]
...
def test_transform_gcp_instance_groups_handles_non_v1_uri_shape():
    responses = [
        {
            ...
            "items": [
                {
                    "name": "ig-non-v1",
                    "network": "https://www.googleapis.com/compute/beta/projects/sample-project-123456/global/networks/default",
                    "subnetwork": "projects/sample-project-123456/regions/us-central1/subnetworks/default",
                    "_members": [
                        {
                            "instance": "https://www.googleapis.com/compute/beta/projects/sample-project-123456/zones/us-central1-a/instances/vm-beta",
                        },
                    ],
                },
            ],
    ...
    assert (
        item["network_partial_uri"]
        == "https://www.googleapis.com/compute/beta/projects/sample-project-123456/global/networks/default"
    )
    assert (
        item["subnetwork_partial_uri"]
        == "projects/sample-project-123456/regions/us-central1/subnetworks/default"
    ...
    assert item["member_instance_partial_uris"] == [
        "https://www.googleapis.com/compute/beta/projects/sample-project-123456/zones/us-central1-a/instances/vm-beta",
    ]
