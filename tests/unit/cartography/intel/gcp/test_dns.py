...
=======
from unittest.mock import MagicMock, patch
>>>>>>> 302b65d (test: Enhance GCP DNS sync tests with comprehensive scenarios and cleanup validation)
import cartography.intel.gcp.dns
from cartography.intel.gcp.dns import sync
import tests.data.gcp.dns
from tests.integration.conftest import neo4j_session
...
>>>>>>> 0f345e7 (test: Add unit tests for DNS zones and record sets loading)
=======
