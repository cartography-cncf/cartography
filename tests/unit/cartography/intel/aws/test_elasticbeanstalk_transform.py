from cartography.intel.aws.elasticbeanstalk import transform_elasticbeanstalk_environments
...
def test_transform_elasticbeanstalk_environments():
    ...
    transformed_environments = transform_elasticbeanstalk_environments(environments=environments, region="test")

    assert len(transformed_environments) == 1

    assert transformed_environments[0]["ASG_NAMES"] == ['asg1','asg2']
    assert transformed_environments[0]["INSTANCE_IDS"] == ['i-instance1','i-instance2','i-instance3','i-instance4']
