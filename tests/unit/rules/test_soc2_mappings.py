...
EXPECTED_SOC2_REQUIREMENTS = {
    ...
    "device_security_posture_gaps": {"CC6.1", "CC6.8", "CC7.1"},
    "eol_software": {"CC7.1"},
    ...
    "gcp_cloudsql_postgres_log_connections_not_on": {"CC7.1"},
    "gcp_cloudsql_postgres_log_disconnections_not_on": {"CC7.1"},
    ...
    "gcp_cloudsql_postgres_pgaudit_not_enabled": {"CC7.1"},
    ...
    "malicious-npm-dependencies-shai-hulud": {"CC6.8", "CC7.1", "CC9.2"},
    "mfa-missing": {"CC6.1"},
