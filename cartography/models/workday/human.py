...
class WorkdayHumanNodeProperties(CartographyNodeProperties):
    ...
    country: PropertyRef = PropertyRef("Location_Address_-_Country")
    email: PropertyRef = PropertyRef("Email_-_Work", extra_index=True)
    cost_center: PropertyRef = PropertyRef("Cost_Center")
    function: PropertyRef = PropertyRef("GBL-Custom-Function")
    sub_function: PropertyRef = PropertyRef("Sub-Function")
