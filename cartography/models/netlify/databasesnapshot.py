...
class NetlifyDatabaseSnapshotNodeProperties(CartographyNodeProperties):
    ...
    source_branch_node_id: PropertyRef = PropertyRef("source_branch_node_id")
    source_branch_id: PropertyRef = PropertyRef("source_branch_id")
    ...
    manual: PropertyRef = PropertyRef("manual")
