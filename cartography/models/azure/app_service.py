...
class AzureAppServiceToSubscriptionRel(CartographyRelSchema):
    ...
    properties: AzureAppServiceToSubscriptionRelProperties = AzureAppServiceToSubscriptionRelProperties()
...
class AzureAppServiceSchema(CartographyNodeSchema):
    ...
    sub_resource_relationship: AzureAppServiceToSubscriptionRel = AzureAppServiceToSubscriptionRel()