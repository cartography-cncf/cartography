...
class AzureLogicAppToSubscriptionRel(CartographyRelSchema):
    ...
    properties: AzureLogicAppToSubscriptionRelProperties = AzureLogicAppToSubscriptionRelProperties()
...
class AzureLogicAppSchema(CartographyNodeSchema):
    ...
    sub_resource_relationship: AzureLogicAppToSubscriptionRel = AzureLogicAppToSubscriptionRel()