...
class AzureDataLakeFileSystemToStorageAccountRel(CartographyRelSchema):
    ...
    properties: AzureDataLakeFileSystemToStorageAccountRelProperties = AzureDataLakeFileSystemToStorageAccountRelProperties()
...
class AzureDataLakeFileSystemSchema(CartographyNodeSchema):
    ...
    sub_resource_relationship: AzureDataLakeFileSystemToStorageAccountRel = AzureDataLakeFileSystemToStorageAccountRel()