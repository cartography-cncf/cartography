...
class AzureEventGridTopicToSubscriptionRel(CartographyRelSchema):
    ...
    properties: AzureEventGridTopicToSubscriptionRelProperties = AzureEventGridTopicToSubscriptionRelProperties()
...
class AzureEventGridTopicSchema(CartographyNodeSchema):
    ...
    sub_resource_relationship: AzureEventGridTopicToSubscriptionRel = AzureEventGridTopicToSubscriptionRel()