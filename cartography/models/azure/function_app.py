...
class AzureFunctionAppToSubscriptionRel(CartographyRelSchema):
    ...
    properties: AzureFunctionAppToSubscriptionRelProperties = AzureFunctionAppToSubscriptionRelProperties()
...
class AzureFunctionAppSchema(CartographyNodeSchema):
    ...
    sub_resource_relationship: AzureFunctionAppToSubscriptionRel = AzureFunctionAppToSubscriptionRel()