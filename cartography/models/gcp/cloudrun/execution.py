...
class GCPCloudRunExecutionProperties(CartographyNodeProperties):
    ...
    job: PropertyRef = PropertyRef("job")  # Full job name/ID
...
@dataclass(frozen=True)
class JobToCloudRunExecutionRelProperties(CartographyRelProperties):
    lastupdated: PropertyRef = PropertyRef("lastupdated", set_in_kwargs=True)


@dataclass(frozen=True)
class JobToCloudRunExecutionRel(CartographyRelSchema):
    ...
    properties: JobToCloudRunExecutionRelProperties = (
        JobToCloudRunExecutionRelProperties()
    )
