    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(
                    ontology_field="inactive", node_field="account_enabled", special_handling="invert_boolean"
                ),
            ],
        ),
    ],
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(
                    ontology_field="has_mfa", node_field="multifactor", special_handling="to_boolean"
                ),
                OntologyFieldMapping(
                    ontology_field="inactive", node_field="disabled"
                ),
                OntologyFieldMapping(
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(ontology_field="fullname", node_field="name"),
                OntologyFieldMapping(ontology_field="has_mfa", node_field="is_enrolled_in_2_sv"),
                OntologyFieldMapping(
                    ontology_field="inactive", node_field="suspended", extra={'fields': ['archived']}, special_handling="or_boolean"
                ),
                OntologyFieldMapping(
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(ontology_field='inactive', node_field='status', extra={'values': ['rejected', 'pending']}, special_handling='equal_boolean'),
                OntologyFieldMapping(ontology_field="has_mfa", node_field="two_factor_authentication_enabled"),
            ],
        ),
    ],
)
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(ontology_field="lastactivity", node_field="last_login"),
                OntologyFieldMapping(ontology_field="inactive", node_field="status", extra={'values': ['disabled', 'locked out', 'pending deletion']}, special_handling='equal_boolean'),
            ],
        ),
    ],
)
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(ontology_field="inactive", node_field="enabled", special_handling="invert_boolean"),
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(ontology_field="lastactivity", node_field="last_login_at"),
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(
                    ontology_field="inactive", node_field="status", extra={'values': ['suspended', 'needs-approval', 'over-billing-limit']}, special_handling='equal_boolean'
                ),
    ...
    nodes=[
        OntologyNodeMapping(
            ...
            fields=[
                ...
                OntologyFieldMapping(ontology_field="lastactivity", node_field="passwordlastused"),
            ],
        ),
        OntologyNodeMapping(
