...
class AWSServerCertificateNodeProperties(CartographyNodeProperties):
    ...
    server_certificate_id: PropertyRef = PropertyRef("ServerCertificateId", extra_index=True)
    server_certificate_name: PropertyRef = PropertyRef("ServerCertificateName", extra_index=True)
...
class AWSServerCertificateSchema(CartographyNodeSchema):
    ...
    properties: AWSServerCertificateNodeProperties = AWSServerCertificateNodeProperties()
