...
from cartography.models.aws.extra_labels import LegacyCloudTrailTrailLabel
...
class CloudTrailTrailSchema(CartographyNodeSchema):
    ...
    extra_node_labels: ExtraNodeLabels = ExtraNodeLabels([LegacyCloudTrailTrailLabel()])
