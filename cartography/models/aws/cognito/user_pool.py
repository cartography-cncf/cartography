...
from cartography.models.aws.extra_labels import LegacyCognitoUserPoolLabel
...
class CognitoUserPoolSchema(CartographyNodeSchema):
    ...
    extra_node_labels: ExtraNodeLabels = ExtraNodeLabels([LegacyCognitoUserPoolLabel()])
