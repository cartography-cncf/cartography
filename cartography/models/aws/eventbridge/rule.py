...
from cartography.models.aws.extra_labels import LegacyEventBridgeRuleLabel
...
class EventBridgeRuleSchema(CartographyNodeSchema):
    ...
    extra_node_labels: ExtraNodeLabels = ExtraNodeLabels([LegacyEventBridgeRuleLabel()])
