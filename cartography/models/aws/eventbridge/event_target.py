...
class EventTargetToEventRuleRel(CartographyRelSchema):
    ...
    target_node_matcher: TargetNodeMatcher = make_target_node_matcher({"arn": PropertyRef("RuleArn")})
    direction: LinkDirection = LinkDirection.INWARD
...
class EventTargetSchema(CartographyNodeSchema):
    ...
    other_relationships: OtherRelationships = OtherRelationships([EventTargetToEventRuleRel()]) 
