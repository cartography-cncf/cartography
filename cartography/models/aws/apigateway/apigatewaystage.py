...
from cartography.models.aws.extra_labels import LegacyAPIGatewayStageLabel
...
class APIGatewayStageSchema(CartographyNodeSchema):
    ...
    extra_node_labels: ExtraNodeLabels = ExtraNodeLabels([LegacyAPIGatewayStageLabel()])
