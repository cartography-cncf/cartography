...
class EKSClusterNodeProperties(CartographyNodeProperties):
    ...
    endpoint_public_access: PropertyRef = PropertyRef("ClusterEndpointPublic", extra_index=True)  # Populated from sync input and read by aws_eks_asset_exposure.json.
    exposed_internet: PropertyRef = PropertyRef("exposed_internet", extra_index=True)  # Populated by aws_eks_asset_exposure.json.
