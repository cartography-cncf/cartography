...
class KubernetesContainerToKubernetesPod(CartographyRelSchema):
    ...
    properties: KubernetesContainerToKubernetesPodProperties = KubernetesContainerToKubernetesPodProperties()
...
class KubernetesContainerSchema(CartographyNodeSchema):
    ...
    # sub_resource_relationship: KubernetesContainerToKubernetesNamespace = KubernetesContainerToKubernetesNamespace()
