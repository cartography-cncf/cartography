...
@dataclass(frozen=True)
class CloudflareMemberToCloudflareRolePropertiesRelProperties(CartographyRelProperties):
    lastupdated: PropertyRef = PropertyRef("lastupdated", set_in_kwargs=True)
...
class CloudflareMemberToCloudflareRoleRel(CartographyRelSchema):
    ...
    properties: CloudflareMemberToCloudflareRolePropertiesRelProperties = (
        CloudflareMemberToCloudflareRolePropertiesRelProperties()
    )
