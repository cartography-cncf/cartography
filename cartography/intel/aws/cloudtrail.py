...
@timeit
@aws_handle_regions
def get_cloudtrail_trails(boto3_session: boto3.Session, region: str) -> List[Dict[str, Any]]:
...
def cleanup(
    ...
    cleanup_job = GraphJob.from_node_schema(CloudTrailTrailSchema(), common_job_parameters)
