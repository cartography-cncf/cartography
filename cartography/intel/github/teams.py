...
def _get_teams_repos_inner_func(
    ...
    logger.debug("Retrieving team repos for %s.", team_name)
...
def _get_teams_users_inner_func(
    ...
    logger.debug("Retrieving team users for %s.", team_name)
...
def _get_child_teams_inner_func(
    ...
    logger.debug("Retrieving child teams for %s.", team_name)
