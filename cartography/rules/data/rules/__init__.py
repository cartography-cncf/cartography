...
RULES = {
    ...
    cis_aws_1_11_unused_credentials.id: cis_aws_1_11_unused_credentials,
    cis_aws_1_12_multiple_access_keys.id: cis_aws_1_12_multiple_access_keys,
    cis_aws_1_13_access_key_not_rotated.id: cis_aws_1_13_access_key_not_rotated,
    cis_aws_1_14_user_direct_policies.id: cis_aws_1_14_user_direct_policies,
    ...
    cis_aws_3_2_cloudtrail_log_validation.id: cis_aws_3_2_cloudtrail_log_validation,
    cis_aws_3_5_cloudtrail_encryption.id: cis_aws_3_5_cloudtrail_encryption,
    # CIS AWS Networking Rules (Section 5)
    cis_aws_5_2_nacl_admin_ports_ipv4.id: cis_aws_5_2_nacl_admin_ports_ipv4,
    cis_aws_5_3_security_group_admin_ports_ipv4.id: cis_aws_5_3_security_group_admin_ports_ipv4,
    ...
    aws_cloudtrail_cloudwatch_integration.id: aws_cloudtrail_cloudwatch_integration,
    aws_s3_bucket_versioning.id: aws_s3_bucket_versioning,
    aws_s3_bucket_access_logging.id: aws_s3_bucket_access_logging,
    aws_s3_default_encryption.id: aws_s3_default_encryption,
