...
cis_1_14_access_key_not_rotated = Rule(
    ...
    tags=("cis", "cis_1_14", "cis_aws_5.0", "iam", "credentials"),
    version="1.0.0",
...
cis_1_12_unused_credentials = Rule(
    ...
    tags=("cis", "cis_1_12", "cis_aws_5.0", "iam", "credentials"),
    version="1.0.0",
    references=CIS_REFERENCES,
)
...
cis_1_15_user_direct_policies = Rule(
    ...
    tags=("cis", "cis_1_15", "cis_aws_5.0", "iam", "policies"),
    version="1.0.0",
    references=CIS_REFERENCES,
)
...
cis_1_13_multiple_access_keys = Rule(
    ...
    tags=("cis", "cis_1_13", "cis_aws_5.0", "iam", "credentials"),
    version="1.0.0",
    references=CIS_REFERENCES,
)
...
cis_1_18_expired_certificates = Rule(
    ...
    tags=("cis", "cis_1_18", "cis_aws_5.0", "certificates", "acm"),
    version="1.0.0",
    references=CIS_REFERENCES,
)
