...
CREATE INDEX IF NOT EXISTS FOR (n:AWSIpRange) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSIpRange) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:AWSIpRule) ON (n.ruleid);
CREATE INDEX IF NOT EXISTS FOR (n:AWSIpRule) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:AWSIpPermissionInbound) ON (n.ruleid);
CREATE INDEX IF NOT EXISTS FOR (n:AWSIpPermissionInbound) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:GCPIpRange) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPIpRange) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:GCPIpRule) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPIpRule) ON (n.lastupdated);
