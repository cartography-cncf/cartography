...
CREATE INDEX IF NOT EXISTS FOR (n:EC2Image) ON (n.imageid);
...
CREATE INDEX IF NOT EXISTS FOR (n:EC2RouteTable) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:EC2Route) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:EC2RouteTableAssociation) ON (n.id);
...
CREATE INDEX IF NOT EXISTS FOR (n:GCPComputeInstance) ON (n.self_link);
...
CREATE INDEX IF NOT EXISTS FOR (n:GitHubTeam) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabGroup) ON (n.group_id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabProject) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabProject) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabRepository) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabDependency) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabMember) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GitLabMember) ON (n.name);
...
CREATE INDEX IF NOT EXISTS FOR (n:GCPSQLDatabase) ON (n.id);
...
CREATE INDEX IF NOT EXISTS FOR (n:AzureVMScaleSet) ON (n.id);
...
CREATE INDEX IF NOT EXISTS FOR (n:BitbucketWorkspace) ON (n.uuid);
CREATE INDEX IF NOT EXISTS FOR (n:BitbucketWorkspace) ON (n.slug);
CREATE INDEX IF NOT EXISTS FOR (n:ProgrammingLanguage) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:EKSClusterNodeGroup) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticacheTopic) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSExternalPrincipal) ON (n.principal);
CREATE INDEX IF NOT EXISTS FOR (n:AWSPrincipal) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSOrganization) ON (n.identity_store_arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSPermissionSet) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSGroup) ON (n.groupid);
CREATE INDEX IF NOT EXISTS FOR (n:AWSGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSUser) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:DBSubnetGroup) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:DBSubnetGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSDNSRecord) ON (n.value);
CREATE INDEX IF NOT EXISTS FOR (n:DNSZone) ON (n.zoneid);
CREATE INDEX IF NOT EXISTS FOR (n:S3PolicyStatement) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSSNSTopicSubscription) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSWAFClassicWebACL) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AWSWAFv2WebACL) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:EC2SecurityGroup) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:IpPermissionEgress) ON (n.ruleid);
CREATE INDEX IF NOT EXISTS FOR (n:AWSTransitGateway) ON (n.tgw_id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureResourceGroup) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:AzureNetworkLoadBalancer) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureNetworkBastionHost) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzurePublicIPAddress) ON (n.ipaddress);
CREATE INDEX IF NOT EXISTS FOR (n:AzureLoadBalancerFrontendIPConfiguration) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureLoadBalancerBackendAddressPool) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureNetworkInterfaceIPConfiguration) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureFirewallRule) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureServerPrivateEndpointConnection) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureManagedIdentity) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPPrincipal) ON (n.email);
CREATE INDEX IF NOT EXISTS FOR (n:GCPAcl) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPLoggingMetric) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPLoggingSink) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPBackendBucket) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPBackendService) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPUrlMap) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPBinding) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPMonitoringAlertPolicy) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPMonitoringMetricDescriptor) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPMonitoringNotificationChannel) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPMonitoringUptimeCheckConfig) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPComputeDisk) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPProxy) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPFirewall) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPPublicIpAddress) ON (n.ipAddress);
CREATE INDEX IF NOT EXISTS FOR (n:GCPIpRule) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPPubsubTopic) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPPubsubSubscription) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPDataProcCluster) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPAPIKey) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPHealthCheck) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPInstanceGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPSSLPolicy) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPBucketPolicyBinding) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCITenancy) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCICompartment) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIUser) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIPolicy) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIRegion) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIInstance) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIVnicAttachment) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIImage) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIBootVolumeAttachment) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIVolumeAttachment) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIOKECluster) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIOKENodePool) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIStorageBucket) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIBlockVolume) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIBootVolume) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIVolumeBackup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIFileSystem) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIMountTarget) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIVcn) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCISubnet) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCISecurityList) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCINetworkSecurityGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCINsgSecurityRule) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIInternetGateway) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCINatGateway) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIRouteTable) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIVnic) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIFlowLog) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIKmsVault) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIKmsKey) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIAuditConfiguration) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCILogGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCILog) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCILoggingService) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCILoggingConfiguration) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIMonitoringAlarm) ON (n.id);
