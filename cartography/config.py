class Config:
    ...
    :type aws_inspector_batch_size: int
    :param aws_inspector_batch_size: Batch size for AWS Inspector findings sync. Controls how many findings are
        fetched and processed at a time. Default is 1000. Optional.
    ...
    def __init__(
        ...
        self.aws_inspector_batch_size = aws_inspector_batch_size
