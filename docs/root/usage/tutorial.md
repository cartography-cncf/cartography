...
Cartography adds custom attributes to nodes and relationships to point out security-related items of interest. Built-in data augmentation jobs are typed analysis jobs under `cartography/models/*/analysis.py`. Here is a summary of all of Cartography's custom attributes.
