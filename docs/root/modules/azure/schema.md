...
|api_server_public_access| True when the Kubernetes API server is reachable from the public internet (i.e. `apiServerAccessProfile.enablePrivateCluster` is not set or false). |
