...
channel you want to ingest. Discovering every private channel without joining it
requires Slack Enterprise Grid and the Admin Conversations API, which this
