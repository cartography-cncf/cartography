...
This module also includes Microsoft Intune support, ingesting managed devices, detected apps, and compliance policies. Intune uses the same Microsoft credentials and requires the following additional Microsoft Graph API permissions:
