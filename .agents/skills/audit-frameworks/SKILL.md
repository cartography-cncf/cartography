...
2. Keeper: `aws_s3_public_buckets`. Action: append `Framework(name="ISO/IEC 27001", short_name="iso27001", requirement="A.13.1.1", control_title="...")` to its `frameworks=` tuple, delete `storage_public_exposure`, drop the import from `__init__.py`.
