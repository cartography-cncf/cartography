...
1. Keep aws_public_rds_instances. Add Framework(short_name="27001", requirement="A.13.1.1", control_title=..., ...). Remove iso27001_public_databases. Update __init__.py.
2. ...
```
...
2. Keeper: `aws_s3_public_buckets`. Action: append `Framework(name="ISO 27001", short_name="27001", requirement="A.13.1.1", control_title="...")` to its `frameworks=` tuple, delete `storage_public_exposure`, drop the import from `__init__.py`.
