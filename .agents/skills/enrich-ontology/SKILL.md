...
| `Database`        | This node has the extra label `Database` to enable cross-platform queries for databases across different systems (e.g., RDSInstance, AWSDynamoDBTable, BigQueryDataset).                    |
