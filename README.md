...
- [Google Cloud Platform](https://cartography-cncf.github.io/cartography/modules/gcp/index.html) - Bigtable, Cloud Resource Manager, Cloud Run, Cloud SQL, Compute, DNS, Storage, Google Kubernetes Engine, Vertex AI
