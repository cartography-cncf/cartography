...
- [Microsoft](https://cartography-cncf.github.io/cartography/modules/microsoft/index.html) - Entra users, groups, applications, OUs, app roles, federation to AWS Identity Center, Intune managed devices, Intune detected apps, Intune compliance policies
