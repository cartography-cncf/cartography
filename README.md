...
- [Microsoft](https://docs.cartography.dev/modules/microsoft/index.html) - Entra ID users, groups, applications and roles; Intune devices and policies; Office 365 licenses; optional Defender for Endpoint machines and unresolved alerts
