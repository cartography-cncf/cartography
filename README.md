...
- [Microsoft Azure](https://cartography-cncf.github.io/cartography/modules/azure/index.html) - App Service, CosmosDB, Functions, Kubernetes Service, Logic Apps, Resource Group, SQL, Storage, Virtual Machine
