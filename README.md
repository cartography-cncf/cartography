...
- [Google Cloud Platform](https://cartography-cncf.github.io/cartography/modules/gcp/index.html) - Cloud Run, Cloud Resource Manager, Compute, DNS, Storage, Google Kubernetes Engine
