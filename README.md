...
- [Google Cloud Platform](https://cartography-cncf.github.io/cartography/modules/gcp/index.html) - Artifact Registry, Bigtable, Cloud SQL, Cloud Resource Manager, Compute, DNS, Storage, Google Kubernetes Engine, Vertex AI
