...
- [Google Cloud Platform](https://cartography-cncf.github.io/cartography/modules/gcp/index.html) - Cloud SQL, Cloud Resource Manager, Compute, DNS, Storage, Google Kubernetes Engine
